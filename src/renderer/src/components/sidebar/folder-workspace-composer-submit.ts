...
import { preflightFolderWorkspaceAgentTrust } from './folder-workspace-composer-agent-trust'
import {
  buildFolderWorkspaceLinkedStartupPlan,
  resolveFolderWorkspaceLaunchDraft
} from './folder-workspace-composer-submit-startup'
...
export async function submitFolderWorkspaceCreate({
  ...
  const agentLaunchRoute = quickAgent
    ? resolveAgentLaunchRoute({
        ...
        launchDraftText: launchDraftPrompt ?? note,
