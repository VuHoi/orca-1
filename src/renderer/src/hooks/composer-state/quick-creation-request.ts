...
export type QuickCreationRequestInput = {
  ...
  structuredInitialOptions?: WorktreeCreationRequest['structuredInitialOptions']
...
export function buildQuickCreationRequest(
  ...
  return {
    ...
    ...(input.structuredInitialOptions
      ? { structuredInitialOptions: input.structuredInitialOptions }
      : {}),
