    ...
    async (
      ...
      const agentLaunchRoute = agent
        ? resolveAgentLaunchRoute({
            ...
            launchDraftText: quickDraftPrompt ?? quickPrompt,
            ...
            initialSessionOptions: normalizeStructuredCodexInitialOptions(
      ...
      const request = buildQuickCreationRequest({
        ...
        note: trimmedNote,
        startupPlan,
        structuredInitialOptions: normalizeStructuredCodexInitialOptions(
          startupPlan?.sessionOptions
        ),
        quickPrompt,
